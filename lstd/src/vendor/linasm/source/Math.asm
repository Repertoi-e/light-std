...
if x eq d
	pmovsxdq	ipart, ipart				; convert s32 to s64
end if
;---[Call exponentiation function]---------
		jmp		Func						; return Func (fpart, ipart)
}
...
if x eq s
	cvtdq2ps	temp2, temp2				; convert s32 to f32
else if x eq d
		pshufd	temp2, temp2, 0xD8			; pack s64 ot s32
	cvtdq2pd	temp2, temp2				; convert s32 to f64
end if
...
;******************************************************************************;
align 16
sbias8			dq	2 dup (0x8080808080808080)	; Value to map u8 to s8
sbias16			dq	2 dup (0x8000800080008000)	; Value to map u16 to s16
sbias32			dq	2 dup (0x8000000080000000)	; Value to map u32 to s32
sbias64			dq	2 dup (0x8000000000000000)	; Value to map u64 to s64
...
hmask_flt32		dd	4 dup (0xFFFFF000)			; Mask to extract high part from f32 value
...
; Range reduction mask
hmask_flt64		dq	2 dup (0xFFFFFFFFF8000000)	; Mask to extract high part from f64 value
...
;==============================================================================;
;       Coefficients to compute exp(x) for f32 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute log(x) for f32 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Scale values for hypot and cath functions for f32 type             ;
;==============================================================================;
...
;==============================================================================;
;       Coefficients to compute sin(x) for f32 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute cos(x) for f32 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute arcsin(x) for f32 type                     ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute arctan(x) for f32 type                     ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Table of integer powers of 10^x for f32 type                       ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute exp(x) for f64 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute log(x) for f64 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Scale values for hypot and cath functions for f64 type             ;
;==============================================================================;
...
;==============================================================================;
;       Coefficients to compute sin(x) for f64 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute cos(x) for f64 type                        ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute arcsin(x) for f64 type                     ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Coefficients to compute arctan(x) for f64 type                     ;
;==============================================================================;
align 16
...
;==============================================================================;
;       Table of integer powers of 10^x for f64 type                       ;
;==============================================================================;
align 16
