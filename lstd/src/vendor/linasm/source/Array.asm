...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_f64O_FLT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movupd	temp, [iter2 + soffst]
	cvtpd2ps	temp, temp
		move	[iter1 + toffst], temp
}
macro	CONVERT_f64O_FLT32_SCALAR	reg
{
	cvtsd2ss	temp, [source]
		movss	[target], temp
}
ConvertToFlt32_flt64:	CONVERT	eax, movlps, movlps, CONVERT_f64O_FLT32_VECTOR, CONVERT_f64O_FLT32_SCALAR, 2, 3, 8, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert flt32 to flt64                                                 ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_f32O_FLT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movlps	temp, [iter2 + soffst]
	cvtps2pd	temp, temp
		move	[iter1 + toffst], temp
}
macro	CONVERT_f32O_FLT64_SCALAR	reg
{
	cvtss2sd	temp, [source]
		movsd	[target], temp
}
ConvertToFlt64_flt32:	CONVERT	rax, movupd, movapd, CONVERT_f32O_FLT64_VECTOR, CONVERT_f32O_FLT64_SCALAR, 3, 2, 16, 8
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_s32O_FLT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movdqu	temp, [iter2 + soffst]
	cvtdq2ps	temp, temp
		move	[iter1 + toffst], temp
}
macro	CONVERT_s32O_FLT32_SCALAR	reg
{
	cvtsi2ss 	temp, dword [source]
		movss	[target], temp
}
ConvertToFlt32_sint32:	CONVERT	eax, movups, movaps, CONVERT_s32O_FLT32_VECTOR, CONVERT_s32O_FLT32_SCALAR, 2, 2, 16, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert sint64 to flt32                                                ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_s64O_FLT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
...
macro	CONVERT_s64O_FLT32_SCALAR	reg
{
	cvtsi2ss 	temp, qword [source]
		movss	[target], temp
}
ConvertToFlt32_sint64:	CONVERT	eax, movss, movss, CONVERT_s64O_FLT32_VECTOR, CONVERT_s64O_FLT32_SCALAR, 2, 3, 8, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert sint32 to flt64                                                ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_s32O_FLT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movq	temp, [iter2 + soffst]
	cvtdq2pd	temp, temp
		move	[iter1 + toffst], temp
}
macro	CONVERT_s32O_FLT64_SCALAR	reg
{
	cvtsi2sd 	temp, dword [source]
		movsd	[target], temp
}
ConvertToFlt64_sint32:	CONVERT	rax, movupd, movapd, CONVERT_s32O_FLT64_VECTOR, CONVERT_s32O_FLT64_SCALAR, 3, 2, 16, 8

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert sint64 to flt64                                                ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_s64O_FLT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
...
macro	CONVERT_s64O_FLT64_SCALAR	reg
{
	cvtsi2sd 	temp, qword [source]
		movsd	[target], temp
}
ConvertToFlt64_sint64:	CONVERT	rax, movsd, movsd, CONVERT_s64O_FLT64_VECTOR, CONVERT_s64O_FLT64_SCALAR, 3, 3, 16, 16
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_f32O_SINT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movups	temp, [iter2 + soffst]
	cvtps2dq	temp, temp
		move	[iter1 + toffst], temp
}
macro	CONVERT_f32O_SINT32_SCALAR	reg
{
	cvtss2si 	reg, [source]
		mov		[target], reg
}
ConvertToSint32_flt32:	CONVERT	eax, movdqu, movdqa, CONVERT_f32O_SINT32_VECTOR, CONVERT_f32O_SINT32_SCALAR, 2, 2, 16, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert flt64 to sint32                                                ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_f64O_SINT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movupd	temp, [iter2 + soffst]
	cvtpd2dq	temp, temp
		move	[iter1 + toffst], temp
}
macro	CONVERT_f64O_SINT32_SCALAR	reg
{
	cvtsd2si 	reg, [source]
		mov		[target], reg
}
ConvertToSint32_flt64:	CONVERT	eax, movq, movq, CONVERT_f64O_SINT32_VECTOR, CONVERT_f64O_SINT32_SCALAR, 2, 3, 8, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert flt32 to sint64                                                ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_f32O_SINT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
...
macro	CONVERT_f32O_SINT64_SCALAR	reg
{
	cvtss2si 	reg, [source]
		mov		[target], reg
}
ConvertToSint64_flt32:	CONVERT	rax, mov, mov, CONVERT_f32O_SINT64_VECTOR, CONVERT_f32O_SINT64_SCALAR, 3, 2, 16, 8

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Convert flt64 to sint64                                                ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	CONVERT_f64O_SINT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
...
macro	CONVERT_f64O_SINT64_SCALAR	reg
{
	cvtsd2si 	reg, [source]
		mov		[target], reg
}
ConvertToSint64_flt64:	CONVERT	rax, mov, mov, CONVERT_f64O_SINT64_VECTOR, CONVERT_f64O_SINT64_SCALAR, 3, 3, 16, 16
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	TRUNCATE_f32O_SINT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movups	temp, [iter2 + soffst]
	cvttps2dq	temp, temp
		move	[iter1 + toffst], temp
}
macro	TRUNCATE_f32O_SINT32_SCALAR	reg
{
	cvttss2si 	reg, [source]
		mov		[target], reg
}
TruncateToSint32_flt32:	CONVERT	eax, movdqu, movdqa, TRUNCATE_f32O_SINT32_VECTOR, TRUNCATE_f32O_SINT32_SCALAR, 2, 2, 16, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Truncate flt64 to sint32                                               ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	TRUNCATE_f64O_SINT32_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
		movupd	temp, [iter2 + soffst]
	cvttpd2dq	temp, temp
		move	[iter1 + toffst], temp
}
macro	TRUNCATE_f64O_SINT32_SCALAR	reg
{
	cvttsd2si 	reg, [source]
		mov		[target], reg
}
TruncateToSint32_flt64:	CONVERT	eax, movq, movq, TRUNCATE_f64O_SINT32_VECTOR, TRUNCATE_f64O_SINT32_SCALAR, 2, 3, 8, 16

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Truncate flt32 to sint64                                               ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	TRUNCATE_f32O_SINT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
...
macro	TRUNCATE_f32O_SINT64_SCALAR	reg
{
	cvttss2si 	reg, [source]
		mov		[target], reg
}
TruncateToSint64_flt32:	CONVERT	rax, mov, mov, TRUNCATE_f32O_SINT64_VECTOR, TRUNCATE_f32O_SINT64_SCALAR, 3, 2, 16, 8

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
;       Truncate flt64 to sint64                                               ;
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
macro	TRUNCATE_f64O_SINT64_VECTOR	reg, move, iter1, iter2, toffst, soffst
{
...
macro	TRUNCATE_f64O_SINT64_SCALAR	reg
{
	cvttsd2si 	reg, [source]
		mov		[target], reg
}
TruncateToSint64_flt64:	CONVERT	rax, mov, mov, TRUNCATE_f64O_SINT64_VECTOR, TRUNCATE_f64O_SINT64_SCALAR, 3, 3, 16, 16
