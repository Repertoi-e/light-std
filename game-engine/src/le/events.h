...
struct fmt::formatter<le::mouse_scrolled_event> {
    void format(const le::mouse_scrolled_event &value, format_context *f) const {
        ...
        fmt::sprint(
            &mods,
            "{{\n        Left = {},\n        Middle = {},\n        Right = {},\n        X1 = {},\n        X2 = {},\n}}",
            (bool) (value.ButtonsDown & le::Mouse_Button_Left), (bool) (value.ButtonsDown & le::Mouse_Button_Middle),
            (bool) (value.ButtonsDown & le::Mouse_Button_Right), (bool) (value.ButtonsDown & le::Mouse_Button_X1),
