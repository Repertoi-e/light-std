...
#include "arche/os/windows/api.h"     // Declarations of Win32 functions
#include "arche/os/windows/common.h"  // Declarations of Win32 functions
...
string get_error_string(HRESULT hr) {
    ...
    size_t size = FormatMessageW(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, null, hr, MAKELANGID(LANG_NEUTRAL, SUBLANG_DEFAULT),
                                 (LPWSTR)&message16, 0, null);
