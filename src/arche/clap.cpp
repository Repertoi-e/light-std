...
string clap_get_string(clap_parse_result ref result, string key) {
    ...
    if (val && val->type == CLAP_ARG_STRING) {
        string ret_val = "";
        val->value.visit(match{[ref ret_val](string value) { ret_val = value; }, [](auto) {}});
        return ret_val;
    }
    return "";
}
...
s64 clap_get_int(clap_parse_result ref result, string key) {
    ...
    if (val && val->type == CLAP_ARG_INT) {
        s64 ret_val = 0;
        val->value.visit(match{[ref ret_val](s64 value) { ret_val = value; }, [](auto) {}});
        return ret_val;
    }
    return 0;
}
...
f64 clap_get_float(clap_parse_result ref result, string key) {
    ...
    if (val && val->type == CLAP_ARG_FLOAT) {
        f64 ret_val = 0.0;
        val->value.visit(match{[ref ret_val](f64 value) { ret_val = value; }, [](auto) {}});
        return ret_val;
    }
    return 0.0;
}
...
bool clap_get_bool(clap_parse_result ref result, string key) {
    ...
    if (val && val->type == CLAP_ARG_BOOL) {
        bool ret_val = false;
        val->value.visit(match{[ref ret_val](bool value) { ret_val = value; }, [](auto) {}});
        return ret_val;
    }
    return false;
}

bool clap_has_arg(clap_parse_result ref result, string key) { return search(result.values, key).Value != null; }
