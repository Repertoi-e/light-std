...
// This is useful for e.g. the beginning of the program to completely override the Context.
// Please don't use EVER this inside functions because the caller might not expect it.
// This overrides the context variables for the whole module.
