...
template <typename T> struct numeric : public internal::numeric_base {
  using value_t = T;
};
...
template <> struct numeric<char> : public internal::numeric_integer_base {
...
template <> struct numeric<wchar_t> : public internal::numeric_integer_base {
...
template <> struct numeric<bool> : public internal::numeric_integer_base {
...
template <> struct numeric<u8> : public internal::numeric_integer_base {
...
template <> struct numeric<s16> : public internal::numeric_integer_base {
...
template <> struct numeric<u16> : public internal::numeric_integer_base {
...
template <> struct numeric<char8_t> : public internal::numeric_integer_base {
...
template <> struct numeric<char16_t> : public internal::numeric_integer_base {
...
template <> struct numeric<s32> : public internal::numeric_integer_base {
...
template <> struct numeric<u32> : public internal::numeric_integer_base {
...
template <> struct numeric<long> : public internal::numeric_integer_base {
...
template <> struct numeric<char32_t> : public internal::numeric_integer_base {
public:
...
template <> struct numeric<s64> : public internal::numeric_integer_base {
...
template <> struct numeric<u64> : public internal::numeric_integer_base {
public:
...
export {
  ...
  */
  ...
  constexpr u128 operator*(u128 lhs, u128 rhs) {
    ...
    u128 result =
        u128(lhs.hi * rhs.lo + lhs.lo * rhs.hi + a32 * b32, a00 * b00);
  ...
  constexpr s128 operator/(s128 lhs, s128 rhs) {
    ...
    u128 quotient = 0, remainder = 0;
    div_mod(unsigned_absolute_value(lhs), unsigned_absolute_value(rhs),
            &quotient, &remainder);
...
export {
  template <> struct numeric<u128> : public numeric_integer_base {
  public:
    static constexpr u128 min() { return 0; }
    static constexpr u128 max() {
      return u128(numeric<u64>::max(), numeric<u64>::max());
    }
  ...
  template <> struct numeric<s128> : public numeric_integer_base {
    static constexpr s128 min() { return s128(numeric<s64>::min(), 0); }
    static constexpr s128 max() {
      return s128(numeric<s64>::max(), numeric<u64>::max());
    }
