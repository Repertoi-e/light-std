...
TEST(format_int) {
    ...
    check_unknown_types(42, "bBdoxXnc");
}
...
TEST(plus_sign) {
    ...
    EXPECT_ERROR("Format specifier requires numeric argument", "{0:+}", (void *) 0x42);
}
...
TEST(zero_flag) {
    ...
    EXPECT_ERROR("Format specifier requires numeric argument", "{0:0}", (void *) 0x42);
}
...
TEST(precision) {
    ...
    EXPECT_ERROR("Invalid type specifier", "{0:.2f}", 42l);
    EXPECT_ERROR("Invalid type specifier", "{0:.2f}", 42ul);
    EXPECT_ERROR("Invalid type specifier", "{0:.2f}", 42ll);
    EXPECT_ERROR("Invalid type specifier", "{0:.2f}", 42ull);
    EXPECT_ERROR("Invalid type specifier", "{0:.2%}", 42);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.2}", 42);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.2}", 42u);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.2}", 42l);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.2}", 42ul);
...
TEST(runtime_precision) {
    ...
    EXPECT_ERROR("Invalid type specifier", "{0:.{1}f}", 42l, 2);
    EXPECT_ERROR("Invalid type specifier", "{0:.{1}f}", 42ul, 2);
    EXPECT_ERROR("Invalid type specifier", "{0:.{1}f}", 42ll, 2);
    EXPECT_ERROR("Invalid type specifier", "{0:.{1}f}", 42ull, 2);
    EXPECT_ERROR("Invalid type specifier", "{0:.{1}%}", 42, 2);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.{1}}", 42, 2);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.{1}}", 42u, 2);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.{1}}", 42l, 2);
    EXPECT_ERROR("Precision is not allowed for this argument type", "{0:.{1}}", 42ul, 2);
