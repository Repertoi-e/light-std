...
void build_test_table() {
    ...
    }
    {
        ...
        extern void test_writing_hello_250_times();
        add(*array, test{"writing_hello_250_times", test_writing_hello_250_times});
    }
    {
        auto [_, array] = add(g_TestTable, string("signal.cpp"), {});
        reserve(*array, 10);
        extern void test_member_function();
        add(*array, test{"member_function", test_member_function});
