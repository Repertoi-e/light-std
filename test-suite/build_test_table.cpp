...
void build_test_table() {
  ...
  }
  {
    ...
    add(*array,
        test{"args_in_different_positions", test_args_in_different_positions});
  ...
  }
  {
    ...
    add(*array,
        test{"global_function_delegate", test_global_function_delegate});
    extern void test_member_function_delegate();
    add(*array,
        test{"member_function_delegate", test_member_function_delegate});
