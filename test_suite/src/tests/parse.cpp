...
#define test_parse_int(IntT, options, base, buffer, expectedValue, expectedStatus, expectedRest) \
    {                                                                                            \
        ...
        assert_eq(rest, string(expectedRest));                                                   \
    }
...
TEST(int) {
    ...
    test_parse_int(s32, parse_int_options{}, 10, "1000000000000000000000000", numeric_info<s32>::max(), PARSE_TOO_MANY_DIGITS, "00000000000000");
    test_parse_int(s32, parse_int_options{}, 10, "-1000000000000000000000000", numeric_info<s32>::min(), PARSE_TOO_MANY_DIGITS, "00000000000000");
