...
BOOL EnumDisplaySettingsExW(LPCWSTR lpszDeviceName, DWORD iModeNum,
...
NTSYSAPI ULONGLONG VerSetConditionMask(ULONGLONG ConditionMask, DWORD TypeMask,
                                       BYTE Condition);
...
extern "C" {
HDEVNOTIFY RegisterDeviceNotificationW(HANDLE hRecipient,
...
BOOL IMAGEAPI SymInitialize(HANDLE hProcess, PCSTR UserSearchPath,
                            BOOL fInvadeProcess);
...
BOOL IMAGEAPI
StackWalk64(DWORD MachineType, HANDLE hProcess, HANDLE hThread,
...
BOOL IMAGEAPI SymFromAddr(HANDLE hProcess, DWORD64 Address,
                          PDWORD64 Displacement, PSYMBOL_INFO Symbol);

BOOL IMAGEAPI SymGetLineFromAddrW64(HANDLE hProcess, DWORD64 dwAddr,
...
BOOL ChangeWindowMessageFilterEx(HWND hwnd, UINT message, DWORD action,
...
extern "C" {
BOOL RegisterRawInputDevices(const RAWINPUTDEVICE *pRawInputDevices,
...
void windows_report_hresult_error(
    u32 hresult, const char *apiFunction,
