...
inline const s16 POW10_EXPONENTS[] = {
...
inline gen_digits_result gen_digits_on_start(gen_digits_state &state,
...
inline gen_digits_result on_digit(gen_digits_state &state, char digit,
                                  u64 divisor, u64 remainder, u64 error,
                                  bool integral) {
  ...
  if (dir != round_direction::UP) {
    return dir == round_direction::DOWN ? gen_digits_result::DONE
                                        : gen_digits_result::ERROR;
  }
