...
long long __cdecl _InterlockedExchangeAdd64(long long volatile *_Addend, long long _Value);
short __cdecl     _InterlockedExchange16(short volatile *_Target, short _Value);
long __cdecl      _InterlockedExchange(long volatile *_Target, long _Value);
long long __cdecl _InterlockedExchange64(long long volatile *_Target, long long _Value);

short __cdecl     _InterlockedCompareExchange16(short volatile *_Destination, short _Exchange, short _Comparand);
long __cdecl      _InterlockedCompareExchange(long volatile *_Destination, long _Exchange, long _Comparand);
long long __cdecl _InterlockedCompareExchange64(long long volatile *_Destination, long long _Exchange, long long _Comparand);
}
