...
extern "C" unsigned char __cdecl _BitScanForward64(unsigned long *_Index, unsigned __int64 _Mask);
#endif
...
inline u32 rotate_left_32(u32 x, u32 bits) { return (x << bits) | (x >> (32 - bits)); }

inline u64 rotate_left_64(u64 x, u32 bits) { return (x << bits) | (x >> (64 - bits)); }

inline u32 rotate_right_32(u32 x, u32 bits) { return (x >> bits) | (x << (32 - bits)); }

inline u64 rotate_right_64(u64 x, u32 bits) { return (x >> bits) | (x << (64 - bits)); }
...
#define POWERS_OF_10(factor) factor * 10, factor * 100, factor * 1000, factor * 10000, factor * 100000, factor * 1000000, factor * 10000000, factor * 100000000, factor * 1000000000
...
inline const u64 POWERS_OF_10_64[] = {1, POWERS_OF_10(1), POWERS_OF_10(1000000000ull), 10000000000000000000ull};
