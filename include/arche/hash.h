...
inline u64 get_hash_xxhash64(const byte *key, s64 len, u64 hash_so_far = 0) {
    ...
    u64 p1 = 0x9e3779b185ebca87, p2 = 0xc2b2ae3d27d4eb4f, p3 = 0x165667b19e3779f9, p4 = 0x85ebca77c2b2ae63, p5 = 0x27d4eb2f165667c5;
...
inline u32 get_hash_murmur_32(const byte *key, s64 len, u32 hash_so_far = 0) {
    ...
    switch (len & 3) {
        case 3: t ^= tail[2] << 16; [[fallthrough]];
        case 2: t ^= tail[1] << 8; [[fallthrough]];
        case 1: {
            t ^= tail[0] << 0;
...
inline u64 get_hash(f32 value) { return *(u32 *)&value; }

inline u64 get_hash(f64 value) { return *(u64 *)&value; }

// Hashing strings, based on murmur
// For larger strings, xxhash64 might be better
inline u64 get_hash(string value) { return get_hash_murmur_32((const byte *)value.Data, value.Count, 0); }
