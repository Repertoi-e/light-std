...
// Default: BMP only (0x0000..0xFFFF). Define ARCHE_UNICODE_FULL_RANGE to use full range (0x0000..0x10FFFF).
...
enum class text_locale { Unspecified = -1, Default = 0, Turkic = 1 };
...
inline bool unicode_is_letter(unicode_general_category gc) { return gc <= unicode_general_category::Lo; }

inline bool unicode_is_mark(unicode_general_category gc) { return gc >= unicode_general_category::Mn && gc <= unicode_general_category::Me; }

inline bool unicode_is_number(unicode_general_category gc) { return gc >= unicode_general_category::Nd && gc <= unicode_general_category::No; }

inline bool unicode_is_punctuation(unicode_general_category gc) { return gc >= unicode_general_category::Pc && gc <= unicode_general_category::Po; }

inline bool unicode_is_symbol(unicode_general_category gc) { return gc >= unicode_general_category::Sm && gc <= unicode_general_category::So; }

inline bool unicode_is_separator(unicode_general_category gc) { return gc >= unicode_general_category::Zs && gc <= unicode_general_category::Zp; }

inline bool unicode_is_other(unicode_general_category gc) { return gc >= unicode_general_category::Cc; }

inline bool unicode_is_letter(code_point cp) { return unicode_is_letter(unicode_get_general_category(cp)); }

inline bool unicode_is_mark(code_point cp) { return unicode_is_mark(unicode_get_general_category(cp)); }

inline bool unicode_is_number(code_point cp) { return unicode_is_number(unicode_get_general_category(cp)); }

inline bool unicode_is_punctuation(code_point cp) { return unicode_is_punctuation(unicode_get_general_category(cp)); }

inline bool unicode_is_symbol(code_point cp) { return unicode_is_symbol(unicode_get_general_category(cp)); }

inline bool unicode_is_separator(code_point cp) { return unicode_is_separator(unicode_get_general_category(cp)); }
